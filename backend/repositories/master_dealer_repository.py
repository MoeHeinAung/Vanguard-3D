...
class MasterDealerRepository(BaseRepository):
    def __init__(self, db_manager: DatabaseManager):
        self.db = db_manager
        self.table_name = 'master_dealers'
        self.id_field = 'id'
    ...
    def find_all(self, order_by: str = 'created_at DESC') -> List[Dict[str, Any]]:
        try:
            ...
            print(f"Error in MasterDealerRepository.find_all: {e}", file=sys.stderr)
            raise e
    ...
    def find_by_id(self, entity_id: str) -> Optional[Dict[str, Any]]:
        try:
            ...
            print(f"Error in MasterDealerRepository.find_by_id: {e}", file=sys.stderr)
            raise e
    ...
    def create(self, data: Dict[str, Any]) -> bool:
        try:
            ...
            print(f"Error in MasterDealerRepository.create: {e}", file=sys.stderr)
            raise e
    ...
    def update(self, entity_id: str, data: Dict[str, Any]) -> bool:
        try:
            ...
            print(f"Error in MasterDealerRepository.update: {e}", file=sys.stderr)
            raise e
    ...
    def delete(self, entity_id: str) -> bool:
        try:
            ...
            if 'FOREIGN KEY constraint failed' in str(e):
                raise ValueError(f"Cannot delete master dealer '{entity_id}' as it is referenced by other records.")
            raise e
        except Exception as e:
            print(f"Error in MasterDealerRepository.delete: {e}", file=sys.stderr)
            raise e
